                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            @endif
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{ url('/admin_profile') }}"><i class="fa fa-user"></i>            My Profile</a>
                    ...
                    <form method="POST" action="{{ url('leave') }}">
                        <div class="modal-body">
                            ...
                            <div class="row" style="padding-top: 40px">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" id="datepicker" class="form-control" name="date_filed">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" type="text" value="{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}" readonly name="employee_name">
                            ...
                            <div class="row" style="padding-top: 10px">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" class="form-control" required="true" name="nol">
                            ...
                            <div class="row" style="padding-top: 10px">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" id="datepicker" class="form-control" name="to_date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('overtime') }}">
                        <div class="modal-body">
                            <center><img src="skycraper.png" style="width: 130px; padding-top: 30px"></center>
                            <input class="form-control" type="text" readonly value="Overtime" hidden name="type">
                            <div class="row" style="padding-top: 40px">
                                <div class="col-lg-4">
                                    <input class="form-control" value="{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}" readonly name="employee_name">
                                    <center><small><label><b>Employee Name</b></label></small></center>
                                </div>
                                <div class="col-lg-4">
                                    <input class="form-control" value="{{ Auth::user()->idnumber }}" type="text" readonly name="employee_number">
                            ...
                            <div class="row" style="padding-top: 10px">
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control" type="text" readonly value="{{ Auth::user()->position }}" name="position">
                            ...
                            <div class="row" style="padding-top: 10px">
                                <div class="col-lg-4">
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" id="datepicker" class="form-control" name="date_rt">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control time" type="text" name="in_rt">
                                    <center><small><label><b>Time In (Regular Time)</b></label></small></center>
                                </div>
                                <div class="col-lg-4">
                                    <input class="form-control time" type="text" name="out_rt">
                            ...
                            <div class="row" style="padding-top: 10px">
                                <div class="col-lg-4">
                                    <div class="input-group date" data-provide="datepicker" >
                                        <input type="text" id="datepicker" class="form-control" name="date_ot">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control time" type="text" name="in_ot">
                                    <center><small><label><b>Time In (Overtime)</b></label></small></center>
                                </div>
                                <div class="col-lg-4">
                                    <input class="form-control time" type="text" name="out_ot">
        ...
        <div class="modal fade" id="officialbusiness" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('officialbusiness') }}">
                        <div class="modal-body">
                            <center><img src="skycraper.png" style="width: 130px; padding-top: 30px"></center>
                            <div class="row" style="padding-top: 40px">
                                <div class="col-lg-6">
                                    <input class="form-control" value="{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}" type="text" readonly name="employee_name">
                                    <center><small><label><b>Employee Name</b></label></small></center>
                                </div>
                                <div class="col-lg-6">
                                    <input class="form-control" value="{{ Auth::user()->idnumber }}" type="text" readonly name="employee_number">
                            ...
                            <div class="row" style="padding-top: 10px">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" id="datepicker" class="form-control" name="date_ob">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                    </div>
                            ...
                            <div style="padding-top: 10px">
                                <select class="form-control" class="form-control" aria-describedby="basic-addon1" required="true" name="nol">
                                    <option selected></option>
        ...
        <div class="modal fade" id="scheduleadjustment" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('scheduleadjustment') }}">
                        <div class="modal-body">  
                            <center><img src="skycraper.png" style="width: 130px; padding-top: 30px"></center>
                            ...
                            <div class="row" style="padding-top: 10px">
                                <div class="col-lg-6">
                                    <input class="form-control time" type="text" name="original_in">
                                    <center><small><label><b>Original In</b></label></small></center>
                                </div>
                                <div class="col-lg-6">
                                    <input class="form-control time" type="text" name="original_out">
                                    <center><small><label><b>Original Out</b></label></small></center>
                                </div>
                            </div>
                            <div class="row" style="padding-top: 10px">
                                <div class="col-lg-6">
                                    <input class="form-control time" type="text" name="adjusted_in">
                                    <center><small><label><b>Adjusted In</b></label></small></center>
                                </div>
                                <div class="col-lg-6">
                                    <input class="form-control time" type="text" name="adjusted_out">
